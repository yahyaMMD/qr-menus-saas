    ...
    <DashboardLayout>
      <div className="p-8">
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-3 gap-6 mt-6">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{restaurant.totalScans.toLocaleString()}</p>
                </div>
                <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Link href={`/dashboard/profiles/${profileId}/menus/new`}>
            <div className="bg-white rounded-lg border-2 border-dashed border-gray-300 overflow-hidden hover:border-gray-400 transition-colors cursor-pointer h-full min-h-[320px]">

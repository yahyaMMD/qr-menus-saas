  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-blue-50 flex items-center justify-center p-4">
      <div className="max-w-4xl w-full">
        ...
        <div className="text-center mb-12">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="relative">
                ...
                <div className="animate-bounce">
                  <div className="w-24 h-24 bg-orange-500 rounded-2xl flex items-center justify-center shadow-2xl transform rotate-12">
                ...
                <div className="absolute -bottom-2 -left-2 w-6 h-6 bg-purple-400 rounded-full animate-pulse delay-75"></div>
              </div>
            </div>
          </div>
          ...
          <p className="text-lg text-gray-600 mb-2">
            Oops! Looks like this page is off the menu.
          </p>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-sm text-gray-600">
                  Try going back or contact our support team
                </p>
              </div>
            </div>
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden -z-10">
        ...
        <div className="absolute top-40 right-20 w-24 h-24 bg-blue-200 rounded-full opacity-20 animate-float-delayed"></div>
        <div className="absolute bottom-32 left-1/4 w-40 h-40 bg-purple-200 rounded-full opacity-20 animate-float"></div>
        <div className="absolute bottom-20 right-1/3 w-28 h-28 bg-pink-200 rounded-full opacity-20 animate-float-delayed"></div>
      </div>

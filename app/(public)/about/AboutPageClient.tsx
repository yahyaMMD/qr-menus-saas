            ...
            <div className="relative">
              <div className="aspect-square rounded-2xl overflow-hidden shadow-2xl">
                <img
                  ...
                  alt="Restaurant interior showcasing modern dining experience"
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex gap-3">
                      <button className="p-2 bg-gray-100 hover:bg-orange-100 rounded-lg transition-colors" aria-label={`LinkedIn profile for ${member.name}`}>
                        <Linkedin className="w-4 h-4 text-gray-600" />
                      </button>
                      <button className="p-2 bg-gray-100 hover:bg-orange-100 rounded-lg transition-colors" aria-label={`Email ${member.name}`}>
